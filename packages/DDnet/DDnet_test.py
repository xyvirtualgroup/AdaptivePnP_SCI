...
def test_ddnet(vnoisy, y_bayer=None,Phi=None,model=None, useGPU=True,lr_=0.000001,updata_=False,update_per_iter=1,gray=False):
	...
	if updata_:
		...
		# model.train()
		outv = denoise_seq_ddnet( seq=vnoisy,\
										noise_std=noisestd,\
		...
		up_meas = A_(xall,Phi)
		total_loss=mse(y_bayer,up_meas)
